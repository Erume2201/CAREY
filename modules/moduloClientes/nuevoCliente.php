...
<div class="container col-6">
	...
	<div class="form-group">
	    ...
	    <input type="text" class="form-control" name="nombre" placeholder="Ingresa el nombre del cliente" required>
	</div>
	<br>
	<div class="form-group">
		<label for="exampleInputEmail1" class="form-label">Teléfono:</label>
	    <input type="text" class="form-control" name="numero" id="numero" placeholder="Ingresa el número de teléfono" maxlength="10" required>
	</div>
	<br>
	<div class="form-group">
	...
	<br>
		<select class="form-select" aria-label="Default select example" name="estado" id="estado">
		<option value="">México (predeterminado)</option>
		</select>
	<br>
	<div class="form-group">
	<br>
